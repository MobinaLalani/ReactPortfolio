...
const DetailButton: React.FC<DetailButtonProps> = ({
  ...
  return (
    <div className="inline-block ">
      ...
      {showTooltip && (
        <div className="left-[1%] absolute -top-4 -translate-y-1/2 bg-white text-gray-900 text-sm font-medium px-3 py-2 rounded-lg shadow-lg border border-gray-200 h-fit w-fit">
          ...
          <p className="text-center cursor-pointer" onClick={onFirstClick}>
             {firstText}
          </p>
          <p className="text-center cursor-pointer" onClick={onSecondClick}>
          {secondText}
          </p>
        </div>
      )}
