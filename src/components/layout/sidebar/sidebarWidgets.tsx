...
const sidebarWidget  : Record<string, { roles: string[]; Component: React.FC<{ mini: boolean }> }> =  {
      ...
      return (
        <div className="mt-[25px]">
          ...
          {location.pathname === "/dashboard" && (
            <div className="mt-[25px]">
              <div
                className={`w-full cursor-pointer bg-[#FF4B4B] flex items-center ${
          ...
          {location.pathname === "/dashboard" && !mini && (
            <div className="mt-[25px]">
              <SkeletonDiv
                loading={false}
                className={`w-full bg-[#FF4B4B] p-[16px] flex flex-col items-center justify-between rounded-[28px] h-[204px]`}
              >
          ...
          {location.pathname === "/dashboard" && !mini && (
            <div className="mt-[25px]">
              ...
              <div
                className={`w-full hover:scale-95 active:scale-100 transition-all cursor-pointer border-dashed bg-white border-2 flex-col border-[#FF4B4B] flex items-center justify-center rounded-[28px] h-[124px] mt-[24px]`}
              >
